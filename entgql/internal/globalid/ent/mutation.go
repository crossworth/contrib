...
func (m *UserMutation) SetPostID(id uuid.UUID) {
	m.post = &id
}
...
func (m *UserMutation) PostID() (id uuid.UUID, exists bool) {
	if m.post != nil {
		return *m.post, true
	}
	return
...
func (m *UserMutation) PostIDs() (ids []uuid.UUID) {
	if id := m.post; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *VideoMutation) SetPostID(u uuid.UUID) {
	m.post_id = &u
}

// PostID returns the value of the "post_id" field in the mutation.
func (m *VideoMutation) PostID() (r uuid.UUID, exists bool) {
	v := m.post_id
	if v == nil {
		return
	}
...
// OldPostID returns the old "post_id" field's value of the Video entity.
// If the Video object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *VideoMutation) OldPostID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *VideoMutation) ResetPostID() {
	m.post_id = nil
}
...
func (m *VideoMutation) Fields() []string {
	...
	if m.post_id != nil {
		fields = append(fields, video.FieldPostID)
	}
	return fields
}
