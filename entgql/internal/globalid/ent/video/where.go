...
func PostID(v uuid.UUID) predicate.Video {
	return predicate.Video(func(s *sql.Selector) {
...
func PostIDEQ(v uuid.UUID) predicate.Video {
	return predicate.Video(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldPostID), v))
	})
}
...
func PostIDNEQ(v uuid.UUID) predicate.Video {
	return predicate.Video(func(s *sql.Selector) {
...
func PostIDIn(vs ...uuid.UUID) predicate.Video {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PostIDNotIn(vs ...uuid.UUID) predicate.Video {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PostIDGT(v uuid.UUID) predicate.Video {
	return predicate.Video(func(s *sql.Selector) {
...
func PostIDGTE(v uuid.UUID) predicate.Video {
	return predicate.Video(func(s *sql.Selector) {
...
func PostIDLT(v uuid.UUID) predicate.Video {
	return predicate.Video(func(s *sql.Selector) {
...
func PostIDLTE(v uuid.UUID) predicate.Video {
	return predicate.Video(func(s *sql.Selector) {
